...
<?php  
$query="SELECT * FROM onrevision LEFT JOIN users ON onrevision.user_id=users.id where onrevision.order_id = '$order_id'";
...
echo "<center class='h4 text-danger'>{$result['name']} Id {$result['user_id']} Is Working On This Order</center>";
