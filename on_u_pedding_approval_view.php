...
<?php showResults_files(); ?>
	...
	<div class="card mb-2">
  <div class="card-header bg-danger text-light text-uppercase" align="center"><strong>You Can Update The Files here:</strong></div>
  <div class="card-body bg-warning"> 
    <form action="results_update" method="POST" enctype="multipart/form-data">
